...
public class MemberAdapter extends FirebaseRecyclerAdapter<Member,MemberAdapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public MemberAdapter(@NonNull FirebaseRecyclerOptions<Member> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull Member model) {
        holder.matv.setText(model.getMatv());
        ...
        holder.imgUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final DialogPlus dialogPlus = DialogPlus.newDialog(holder.imgAvatar.getContext())
                        .setContentHolder(new ViewHolder(R.layout.activity_update_member))
